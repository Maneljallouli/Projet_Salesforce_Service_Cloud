...
import LightningConfirm from 'lightning/confirm'; // Import pour la pop-up de confirmation
...
export default class AgentDraftPanel extends LightningElement {
    ...
    // Version modifiée avec Pop-up de confirmation
    async handleSend() {
        ...
        // Si l'utilisateur clique sur "OK", on lance l'envoi
        if (result) {
