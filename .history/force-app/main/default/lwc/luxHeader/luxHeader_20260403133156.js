...
import CONTACT_ID_FIELD from '@salesforce/schema/User.ContactId'; // CORRECTION : Import du lien Contact
...
export default class LuxHeader extends NavigationMixin(LightningElement) {
    ...
    // Récupération des infos utilisateur incluant le ContactId pour le filtrage
    @wire(getRecord, {
        recordId: USER_ID,
    ...
    _subscribeToEvents() {
        const messageCallback = (event) => {
            ...
            // CORRECTION : On compare le ContactId de l'event avec celui de l'utilisateur connecté
            ...
            if (currentContactId === eventContactId) {
                console.log('Match trouvé ! Rafraîchissement des notifications...');
