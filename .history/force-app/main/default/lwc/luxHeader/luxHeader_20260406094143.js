...
export default class LuxHeader extends NavigationMixin(LightningElement) {
    ...
    wiredNotifs(result) {
        ...
        if (data) {
            // Enrichir chaque notif avec la classe CSS et le booléen isRead
            ...
            // Badge = nombre de non-lues uniquement
    ...
    get unreadCount()      { return this.notifications.filter(n => !n.isReadBool).length; }
    ...
    toggleNotifDropdown() {
        if (this.notifDropdownOpen) {
            ...
            // Ouverture : affiche tout, badge disparaît visuellement
